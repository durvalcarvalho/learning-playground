...
namespace WhereIsMyDoctor.Models
{
    ...
    public class MedicoMetadado
    {
        ...
        [StringLength(80, ErrorMessage = "O Endereço deve possuir no máximo 100 caracteres")]
        public string Endereco { get; set; }

        [Required(ErrorMessage = "Obrigatório informar o Bairro")]
        [StringLength(80, ErrorMessage = "O Bairros deve possuir no máximo 60 caracteres")]
        public string Bairro { get; set; }

        [Required(ErrorMessage = "Obrigatório informar o E-mail")]
        [StringLength(80, ErrorMessage = "O E-mail deve possuir no máximo 100 caracteres")]
        ...
        [StringLength(80, ErrorMessage = "O Web site deve possuir no máximo 80 caracteres")]
